...
import { NotificationContainer } from "@/components/NotificationDisplay";
...
const AppContent = () => {
  ...
  useEffect(() => {
    const handleOnline = () => networkStatus(true);
    const handleOffline = () => networkStatus(false);
  ...
  if (phase === 'INITIALIZING') {
    return <LoadingScreen message="Starting Retreat Slice..." />;
  }

  // Show error screen if auth system failed
  if (phase === 'ERROR') {
    return <ErrorScreen />;
  }
