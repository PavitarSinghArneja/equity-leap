-- Fix instant_buy_shares to use valid alert_type
-- Change 'trade_completed' to 'share_sell_request' which is allowed
...
BEGIN
  ...
  -- 6. Send notifications using valid alert_type
